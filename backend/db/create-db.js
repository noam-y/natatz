...
var NEW_VCOMPLAINT_F =
  "INSERT INTO visitors_complaints (date_received, reporter_name, phone,email, taz, car_id, date_commited, details) VALUES ?";
  var NEW_VCOMPLAINT_WO_DATES =
  "INSERT INTO visitors_complaints (reporter_name, phone, email, taz, car_id, details, date_received) VALUES (?, current_date())";
...
mulInsert = (givenValues) => {
  con.query(NEW_VCOMPLAINT_WO_DATES, [givenValues], function (err, result) {
    if (err) throw err;
    console.log("inset");
  });
}
